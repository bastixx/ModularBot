...
def convert(s, message):
    ...
    if match:
        ...
        send_message(s, f"{feet} ft and {inches} in is {round(cm, 2)} cm!")
    else:
        # Convert Feet to cm
        ...
        if match:
            ...
            cm = (feet * 30.48)
            send_message(s, f"{feet} ft is {round(cm, 2)} cm!")
        else:
            # Convert inch to cm
            ...
            if match:
                ...
                cm = (inch * 2.54)
                send_message(s, f"{inch} in is {round(cm, 2)} cm!")
            # Convert Centimetres to Feet and inches
                ...
                if match:
                    ...
                    send_message(s, f"{cm} cm is {int(feet)}ft {round(inches, 1)}in!")
                else:
                    ...
                    if match:
                        ...
                        if match:
                            ...
                            if match:
                                ...
                                send_message(s, f"{kilometres} km is {round(miles, 2)} mi!")
                            else:
                                ...
                                if match:
                                    ...
                                    send_message(s, f"{miles} mi is {round(kilometres, 2)} km!")
                                else:
                                    ...
                                    if match:
                                        ...
                                        if match:
                                            ...
                                            if match:
                                                ...
                                                send_message(s, f"Unable to convert this. Unknown format or typo. "
